...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{__("messagesHeader.login")}}</div>
                            ...
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('password.request') }}">
                                        ...
                                        {{__("messagesLogin.forget")}}
                                        </button>
                                    </a>
                                @endif

                                <br>
                                <a href="{{route('register')}}">{{__('messagesLogin.dontHaveAccount')}}</a>
                            </div>
                        </div>
                    </form>
                </div>
