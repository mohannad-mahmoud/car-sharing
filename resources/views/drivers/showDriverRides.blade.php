...
{{--            <th scope="col">{{__('messagesRides.edit')}}</th>--}}
{{--            <th scope="col">{{__('messagesRides.close')}}</th>--}}
{{--            <th scope="col">{{__('messagesRides.delete')}}</th>--}}
...
{{--                    @endif--}}
{{--                    <td><a href="{{route('edit.driver.ride' , $ride->id)}}"><button class="alert-secondary">{{__('messagesRides.edit')}}</button></a></td>--}}
{{--                    @if($ride->ride_status == __('messagesGlobal.rideIsActive'))--}}
{{--                        <td><a href="{{route('close.driver.ride' , $ride->id)}}"><button--}}
{{--                                    onclick="confirm('Are you sure you want to close this ride')"--}}
{{--                                    class="alert-success">{{__('messagesRides.close')}}</button></a></td>--}}
{{--                    @else--}}
{{--                        <td><a href="{{route('activate.driver.ride' , $ride->id)}}"><button--}}
{{--                                    onclick="confirm('Are you sure you want to activate this ride')"--}}
{{--                                    class="alert-success">{{__('messagesRides.activate')}}</button></a></td>--}}
{{--                    @endif--}}
{{--                    <td><a href="{{route('delete.driver.ride' , $ride->id)}}"><button--}}
{{--                                onclick="confirm('Are you sure you want to Delete this ride')"--}}
{{--                                class="alert-danger">{{__('messagesRides.delete')}}</button></a></td>--}}
{{--                </tr>--}}
{{--            @endforeach--}}
{{--        @endforeach--}}
{{--        </tbody>--}}
                    ...
                    <div class="row">
                                ...
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col-md-6 mb-1">
                                            <h5>{{$driver->user->name}}</h5> <a href="{{route('user.info' , $car->driver->user_id)}}" style="text-decoration: none;"><i class="fa fa-user ml-4"></i></a></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row rightthird">
                                @if(App\Helper\Helper::checkRideBelongsToDriver($ride->id))
                                <div class="col-md-4">
                                    @if($ride->ride_status == __('messagesGlobal.rideIsActive'))
                                        <a href="{{route('close.driver.ride' , $ride->id)}}"><button
                                                onclick="confirm('Are you sure you want to close this ride')"
                                                class="btn btn-info">{{__('messagesRides.close')}}</button></a>
                                    @else
                                        <a href="{{route('activate.driver.ride' , $ride->id)}}"><button
                                                onclick="confirm('Are you sure you want to activate this ride')"
                                                class="btn btn-success">{{__('messagesRides.activate')}}</button></a>
                                    @endif
                                </div>
                                <div class="col-md-4">
                                <a href="{{route('edit.driver.ride' , $ride->id)}}"><button class="btn btn-dark">{{__('messagesRides.edit')}}</button></a>
                                </div>
                                <div class="col-md-4">
                                    <a href="{{route('delete.driver.ride' , $ride->id)}}"><button
                                            onclick="confirm('Are you sure you want to Delete this ride')"
                                            class="btn btn-danger">{{__('messagesRides.delete')}}</button></a>
                                </div>
                                @endif
                            </div>
                        </div>
