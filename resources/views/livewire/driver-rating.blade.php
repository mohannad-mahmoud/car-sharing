                        ...
                        @auth
                            <div class="w-full space-y-5">
                                <p class="font-medium text-blue-500 uppercase">
                                    Rate this Driver {{$driver->user->name}}
                                </p>
                            </div>
                            ...
                            @endif
                            @if($hideForm != true)
                                <form method="post" action="http://127.0.0.1:8000/api/rating/{{Auth()->id()}}/{{$driver->id}}">
                        ...
                        @else
                            <div>
                                <div class="mb-8 text-center text-gray-600">
                                    You need to login in order to be able to rate the Driver!
                                </div>
                                <a href="/register"
